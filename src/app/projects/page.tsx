              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                {projects.map((project, idx) => (
                  <div 
                    ...
                    className="group glass-strong rounded-3xl border border-[#a3a6ff]/10 overflow-hidden hover:border-[#a3a6ff]/30 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up cursor-pointer" 
                  ...
                  >
                    ...
                    <div className="p-8 relative">
                      ...
                      <div className="flex items-center justify-between mt-auto">
                        <span className="text-xs text-[#adaaad] font-medium">Click to view details</span>
                        {project.slug && project.slug.startsWith("http") && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-[#a3a6ff] font-medium text-sm group-hover:gap-2 transition-all"
                          >
