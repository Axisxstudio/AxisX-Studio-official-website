    ...
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0e0e10]">
      ...
      <div className="w-full max-w-md relative z-10 px-6">
        <div className="text-center mb-10">
          <Link href="/" aria-label="AxisX home" className="mb-6 inline-flex items-center hover:scale-105 transition-transform">
            <BrandLogo className="h-auto w-[10rem]" priority />
          </Link>
